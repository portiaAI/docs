...
<details open style={{
  ...
  <p>If you prefer to just dive right into an example, why not head over to the intro example in our <a href="https://github.com/portiaAI/portia-agent-examples" target="_blank">**examples repo (↗)**</a>.</p>
</details>
