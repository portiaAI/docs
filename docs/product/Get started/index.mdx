...
Portia AI is an open source developer framework. We want to make it simple for any developer to deploy stateful, authenticated agentic workflows.
...
- Execute a workflow based on a plan, invoking tools and tracking the workflow state at every step.
